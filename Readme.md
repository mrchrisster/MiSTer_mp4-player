# Groovy core for MiSTer — with MP4 Player extension
...
**Quick start:**
```bash
# 1. Enable MP4 mode in MiSTer OSD: Video Mode → MP4
# 2. Run the daemon:
/media/fat/mp4_play /media/fat/videos/intro.mp4
```

See [doc/mp4_player_mission.md](doc/mp4_player_mission.md) for architecture details and
[doc/arm_dma_architecture.md](doc/arm_dma_architecture.md) for the ARM developer reference.
